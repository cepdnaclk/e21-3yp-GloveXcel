...
/*
  ESP32 Combined Code - Normal ESP32 Board Pin Mapping
  ...
  Removed:
    Vibration motor functionality is removed because this ESP32 setup does not use a vibration motor.
  ...
  Potentiometer Output:
    Serial Monitor:
      GPIO39 = value | GPIO32 = value | GPIO34 = value | GPIO35 = value | GPIO36 = value
...
// =====================================================
// TB6612FNG motor pins - normal ESP32 board mapping
// D2  = GPIO2
// D4  = GPIO4
// D5  = GPIO5
// D19 = GPIO19
...
// =====================================================
// Potentiometer pins
// Order is kept according to your given pin order:
// 39, 32, 34, 35, 36
// =====================================================
const int potPins[5] = {
  39,
...
// BLE notification output is also kept.
// =====================================================
...
void setup() {
  ...
  Serial.println("Function 3: Frontend BLE Web Bluetooth Control");
  Serial.println("Vibration motor: Removed / Not used");
  Serial.println("--------------------------------------------");
  Serial.println("Spring constant k = 182 N/m");
  Serial.println("Spool radius = 4 mm");
  Serial.println("Max level = 10 N");
  Serial.println();
  Serial.println("Motor controller pins:");
  Serial.println("AIN1 -> D2  / GPIO2");
  Serial.println("AIN2 -> D4  / GPIO4");
  Serial.println("PWMA -> D5  / GPIO5");
  Serial.println("STBY -> D19 / GPIO19");
  Serial.println();
  Serial.println("Encoder pins:");
  Serial.println("ENC_C1 -> D21 / GPIO21");
  Serial.println("ENC_C2 -> D18 / GPIO18");
  Serial.println();
  Serial.println("Potentiometer pins:");
  Serial.println("Pot 1 -> GPIO39");
  Serial.println("Pot 2 -> GPIO32");
  Serial.println("Pot 3 -> GPIO34");
  Serial.println("Pot 4 -> GPIO35");
  Serial.println("Pot 5 -> GPIO36");
  Serial.println();
...
void loop() {
  ...
  // Keeps Serial output and also sends BLE packets to frontend
